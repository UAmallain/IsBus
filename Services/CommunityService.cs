...
public class CommunityService : ICommunityService
{
    ...
    public async Task<Community?> FindCommunityAsync(string name, string? province = null)
    {
        ...
        // Try partial matching for multi-word community names
        community = communities.FirstOrDefault(c => 
            c.NameLower.Contains(normalizedName) ||
            normalizedName.Contains(c.NameLower));
